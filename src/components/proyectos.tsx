    ...
    <div className="grid grid-cols-7 gap-4 py-20">
      <div className="text-center col-span-7 md:col-span-3 ">
        <p className="text-center text-xl sm:text-2xl lg:text-3xl">
          {" "}
          <Link className="" href={"/blog/" + props.children.Post.Slug}>
            {props.children.TituloProyect}
          </Link>{" "}
        </p>
      ...
      <Image
        src={props.children.ImagenDescktop.webp.url}
        alt={props.children.ImagenDescktop.Alt}
        width={300}
        height={150}
      ...
      <Image
        src={props.children.ImagenCelu.webp.url}
        alt={props.children.ImagenCelu.Alt}
        width={100}
        height={200}
